...
displot(im, cn=spp[1], var="disrel", dist="gamma", plotit=T, lcol="palegreen3", lab=F, bars=F, add=T , xlab="")
displot(fish, cn=spp[2], var="dis", dist="gamma", plotit=T, lcol="coral3", lab=T, bars=F, xlab="")
displot(im, cn=spp[2], var="disrel", dist="gamma", plotit=T, lcol="palegreen3", lab=F, bars=F, add=T,  xlab="")
...
displot(im, cn=spp[3], var="disrel", dist="gamma", plotit=T, lcol="palegreen3", lab=F, bars=F, add=T)
