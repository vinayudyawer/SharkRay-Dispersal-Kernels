...
#Model A: a simple model looking at activity space over body mass
actsp_bbk95_A <- brm(
  log10(bbk95.km) ~ log10(body.mass.kg) + (1|G.species), data = act.sp.no, 
  family = gaussian(), cov_ranef = list(phylo = A), iter = 10000,
  control = list(adapt_delta = 0.99),#the adapt_delta is set close to 1 (bound from 0.8-1) to reduce the divergences
  prior = priors.AS,
  save_all_pars = TRUE)
actsp_bbk95_A <- add_ic(actsp_bbk95_A, ic=c("waic", "R2", "marglik")) #add IC to model fit for comparison
...
#Model B1: activity space over body mass with lifestyle as a cactor
actsp_bbk95_B1 <- brm(
  log10(bbk95.km) ~ log10(body.mass.kg) + lifestyle + (1|G.species), data = act.sp.no, 
  family = gaussian(), cov_ranef = list(phylo = A), iter = 10000,
  control = list(adapt_delta = 0.99),#the adapt_delta is set close to 1 (bound from 0.8-1) to reduce the divergences
  prior = priors.AS,
  save_all_pars = TRUE)
actsp_bbk95_B1 <- add_ic(actsp_bbk95_B1, ic=c("waic", "R2", "marglik")) #add IC to model fit for comparison
...
actsp_bbk95_B2 <- brm(
  ...
  prior = priors.AS,
  save_all_pars = TRUE)
actsp_bbk95_B2 <- add_ic(actsp_bbk95_B2, ic=c("waic", "R2", "marglik")) #add IC to model fit for comparison
...
#Model C1: activity space over body mass with habitat as a cofactor
actsp_bbk95_C1 <- brm(
  log10(bbk95.km) ~ log10(body.mass.kg) + habitat2 + (1|G.species), data = act.sp.no, 
  family = gaussian(), cov_ranef = list(phylo = A), iter = 10000,
  control = list(adapt_delta = 0.99),#the adapt_delta is set close to 1 (bound from 0.8-1) to reduce the divergences
  prior = priors.AS,
  save_all_pars = TRUE)
actsp_bbk95_C1 <- add_ic(actsp_bbk95_C1, ic=c("waic", "R2", "marglik")) #add IC to model fit for comparison
...
actsp_bbk95_C2 <- brm(
  ...
  prior = priors.AS,
  save_all_pars = TRUE)
actsp_bbk95_C2 <- add_ic(actsp_bbk95_C2, ic=c("waic", "R2", "marglik")) #add IC to model fit for comparison
...
#Model D1: Body mass with Trophic Guild as a cofactor
actsp_bbk95_D1 <- brm(
  log10(bbk95.km) ~ log10(body.mass.kg) + Trophic.group + (1|G.species), data = act.sp.no, 
  family = gaussian(), cov_ranef = list(phylo = A), iter = 10000,
  control = list(adapt_delta = 0.99),#the adapt_delta is set close to 1 (bound from 0.8-1) to reduce the divergences
  prior = priors.AS,
  save_all_pars = TRUE)
actsp_bbk95_D1 <- add_ic(actsp_bbk95_D1, ic=c("waic", "R2", "marglik")) #add IC to model fit for comparison
...
actsp_bbk95_D2 <- brm(
  ...
  prior = priors.AS,
  save_all_pars = TRUE)
actsp_bbk95_D2 <- add_ic(actsp_bbk95_D2, ic=c("waic", "R2", "marglik")) #add IC to model fit for comparison
