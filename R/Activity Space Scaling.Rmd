...
#actsp_A <- readRDS("Model Outputs/actsp_A_190713.rds")
...
loo(actsp_A, actsp_B1, actsp_B2, actsp_C1, actsp_C2, actsp_D1, actsp_D2, "waic")

```

Check out the summary and output of the simple bayesian model

```{r}
summary(actsp_simple)
plot(actsp_simple, N = 2, ask = FALSE)
plot(marginal_effects(actsp_simple), points = TRUE) 
```
