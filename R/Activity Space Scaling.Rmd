...
Look at the size distribution within each species. To be more informative filter out all the species for which there are less than 10 tagged individuals. 
