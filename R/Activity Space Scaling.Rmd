...
```{r}
AS.model <- glm(log10(mcp.km)~log10(body.mass.kg)*subclass + Trophic.group, data = act.sp)
summary(AS.model)
...
AS.mean.phy <- gls(log10(mcp.km)~log10(body.mass) + lifestyle + Trophic.group + subclass, data = act.sp.mean, correlation = corPagel(1,mean.tree), method = "ML")
```
...
actsp_A <- brm(
  ...
  prior = priors.AS,
  save_all_pars = TRUE)
actsp_A <- add_ic(actsp_A, ic=c("waic", "R2", "marglik")) #add IC to model fit for comparison
saveRDS(actsp_A, file="~/Dropbox/Work/Postdoc SFU/Data and Analysis/R/R/Model Outputs/actsp_A_190713.rds")
actsp_A <- readRDS("~/Dropbox/Work/Postdoc SFU/Data and Analysis/R/R/Model Outputs/actsp_A_190713.rds")
...
actsp_B1 <- brm(
  ...
  prior = priors.AS,
  save_all_pars = TRUE)
actsp_B1 <- add_ic(actsp_B1, ic=c("waic", "R2", "marglik")) #add IC to model fit for comparison
saveRDS(actsp_B1, file="~/Dropbox/Work/Postdoc SFU/Data and Analysis/R/R/Model Outputs/actsp_B1_190713.rds")
actsp_B1 <- readRDS("~/Dropbox/Work/Postdoc SFU/Data and Analysis/R/R/Model Outputs/actsp_B1_190713.rds")
...
actsp_B2 <- brm(
  ...
  prior = priors.AS,
  save_all_pars = TRUE)
actsp_B2 <- add_ic(actsp_B2, ic=c("waic", "R2", "marglik")) #add IC to model fit for comparison
saveRDS(actsp_B2, file="~/Dropbox/Work/Postdoc SFU/Data and Analysis/R/R/Model Outputs/actsp_B2_190713.rds")
actsp_B2 <- readRDS("~/Dropbox/Work/Postdoc SFU/Data and Analysis/R/R/Model Outputs/actsp_B2_190713.rds")
...
actsp_C1 <- brm(
  ...
  prior = priors.AS,
  save_all_pars = TRUE)
actsp_C1 <- add_ic(actsp_C1, ic=c("waic", "R2", "marglik")) #add IC to model fit for comparison
saveRDS(actsp_C1, file="~/Dropbox/Work/Postdoc SFU/Data and Analysis/R/R/Model Outputs/actsp_C1_190713.rds")
actsp_C1 <- readRDS("~/Dropbox/Work/Postdoc SFU/Data and Analysis/R/R/Model Outputs/actsp_C1_190713.rds")
...
actsp_C2 <- brm(
  ...
  prior = priors.AS,
  save_all_pars = TRUE)
actsp_C2 <- add_ic(actsp_C2, ic=c("waic", "R2", "marglik")) #add IC to model fit for comparison
saveRDS(actsp_C2, file="~/Dropbox/Work/Postdoc SFU/Data and Analysis/R/R/Model Outputs/actsp_C2_190713.rds")
actsp_C2 <- readRDS("~/Dropbox/Work/Postdoc SFU/Data and Analysis/R/R/Model Outputs/actsp_C2_190713.rds")
...
actsp_D1 <- brm(
  ...
  prior = priors.AS,
  save_all_pars = TRUE)
actsp_D1 <- add_ic(actsp_D1, ic=c("waic", "R2", "marglik")) #add IC to model fit for comparison
saveRDS(actsp_D1, file="~/Dropbox/Work/Postdoc SFU/Data and Analysis/R/R/Model Outputs/actsp_D1_190713.rds")
actsp_D1 <- readRDS("~/Dropbox/Work/Postdoc SFU/Data and Analysis/R/R/Model Outputs/actsp_D1_190713.rds")
...
actsp_D2 <- brm(
  ...
  prior = priors.AS,
  save_all_pars = TRUE)
actsp_D2 <- add_ic(actsp_D2, ic=c("waic", "R2", "marglik")) #add IC to model fit for comparison
saveRDS(actsp_D2, file="~/Dropbox/Work/Postdoc SFU/Data and Analysis/R/R/Model Outputs/actsp_D2_190713.rds")
actsp_D2 <- readRDS("~/Dropbox/Work/Postdoc SFU/Data and Analysis/R/R/Model Outputs/actsp_D2_190713.rds")

#Compare model WAIC values to assess model support
loo(actsp_A, actsp_B1, actsp_B2, actsp_C1, actsp_C2, actsp_D1, actsp_D2, pointwise = TRUE)
```
